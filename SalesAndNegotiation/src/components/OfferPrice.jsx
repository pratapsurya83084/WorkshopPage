  ...
  return (
    <section className=" py-10">
      <div className="container mx-auto flex flex-col justify-center items-center">
        ...
        <div className="text-center">
          <h1 className="text-yellow-200 radius-yellow text-xl sm:text-2xl lg:text-3xl font-bold m-4 p-2 rounded-xl mt-4 lg:mt-6">
            TODAY'S OFFER PRICE : ₹199/-
            </h1>
        </div>
        ...
        <a href="https://pages.razorpay.com/workshopwithbishop" className='mb-10'>
