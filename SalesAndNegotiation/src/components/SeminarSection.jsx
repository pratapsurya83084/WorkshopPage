...
const SeminarSection = () => {
  ...
  return (
    <section 
    ref={sectionRef}
    className="mt-10  radius-yellow bg-custom-brown flex flex-col justify-center rounded-3xl items-center">
    {/* section 20 */}
    <h1 className="smooth-scroll mt-5 p-4  flex justify-center text-center  py-6 font-bold text-xl sm:text-2xl md:text-3xl ">
      Who Will Benefit Most from This Seminar?</h1>
    ...
    <div className="mt-8 lg:flex mx-5 ">
      ...
      <div className="smooth-scroll text-white h-6 w-6 flex justify-center">
